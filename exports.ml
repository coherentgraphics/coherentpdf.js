...
let _ =
  Js.export "cpdflib"
    (object%js
       ...
       method rangeAdd = Cpdflib.addtorange
       method even = Cpdflib.even
       method odd = Cpdflib.odd
       method rangeUnion = Cpdflib.union
       method rangeLength = Cpdflib.lengthrange
       method rangeGet = Cpdflib.readrange
       method difference = Cpdflib.difference
       ...
       method toMemoryExt = Cpdflib.toFileMemoryExt
       method toMemoryEncrypted = Cpdflib.toFileMemoryEncrypted
       method toMemoryEncryptedExt = Cpdflib.toFileMemoryEncryptedExt
       method pages = Cpdflib.pages
       method pagesFast = Cpdflib.pagesFast
       method pagesFastMemory = Cpdflib.pagesFastMemory
       ...
       method setBleedBox = Cpdflib.setBleedBox
       ...
       method markTrappedXMP = Cpdflib.markTrappedXMP
       method markUntrappedXMP = Cpdflib.markUntrappedXMP
